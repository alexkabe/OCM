...
class BaseMutableBuffer {
    ...
    _ensure(size) {
        ...
        if (remaining < size) {
            ...
            this._buffer = this.Buffer.alloc(oldBuffer.length + this._blockSize * factor);
...
exports.BaseMutableBuffer = BaseMutableBuffer;
function isBuffer(obj) {
    return (typeof (obj === null || obj === void 0 ? void 0 : obj.constructor.isBuffer) === 'function' &&
        obj.constructor.isBuffer(obj));
}
//# sourceMappingURL=mbuf.js.map